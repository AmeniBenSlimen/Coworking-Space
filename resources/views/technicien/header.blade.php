			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow">
					...
					<div class="dropdown-menu">
						...
						</div> <a class="dropdown-item" href="{{route('ProfileTechnicien' ,Auth::user()->id)}}">Mon Profile</a>
						 <a class="dropdown-item" href="{{route('FormUpdatePwTechnicien' ,Auth::user()->id)}}">Changer mot de passe </a> 
