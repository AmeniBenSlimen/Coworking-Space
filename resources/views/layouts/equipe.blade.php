...
<img src="{{asset('images/'.$eq->image_equipe)}}" alt="" class="card-img-top">
        ...
        <path d="M0,0V5.63C149.93,59,314.09,71.32,475.83,42.57c43-7.64,84.23-20.12,127.61-26.46,59-8.63,112.48,12.24,165.56,35.4C827.93,77.22,886,95.24,951.2,90c86.53-7,172.46-45.71,248.8-84.81V0Z" class="shape-fill"></path>
              ...
              <div class="card-body">
                <blockquote>
					...
					{{$eq->description_equipe}}
                    </p>
                  </blockquote>
                
              </div>
              <div class="card-footer">
                <p class="mb-0 font-weight-bolder" style="color:#ff5722">{{$eq->prenom_equipe}} {{$eq->nom_equipe}}</p>
                <small class="text-muted">{{$eq->specialite}}</small>
                <p class="mb-0 font-weight-bolder" style="color:#ff5722">{{$eq->telephone_equipe}}</p>
              </div>
