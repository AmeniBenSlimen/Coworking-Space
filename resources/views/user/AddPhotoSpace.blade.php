...
<div class="row">
<div class="col-lg-12">
<form method="POST" action="{{route('AddPhotoSpaceBD')}}" enctype="multipart/form-data">
    @csrf
...
<label>Image</label>
<input type="file" name="image_espace[]" class="form-control @error('image_espace') is-invalid @enderror" required autocomplete="image_espace" multiple autofocus>
</div>
</div>
