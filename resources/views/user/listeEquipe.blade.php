					...
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
                                ...
                                <a href="{{route ('FormEquipe')}}" class="btn btn-primary float-right veiwbutton ">Ajouter Membre</a>
                            </div>
						</div>
					</div>
				</div>
									...
									<table class="table table-striped"  >
                                        ...
                                        @foreach($equipe as $eq)
											<tr>
												<td>{{$eq->id}}</td>
                                                <td>{{$eq->nom_equipe}}</td>
                                                <td>{{$eq->prenom_equipe}}</td>
                                                <td>{{$eq->description_equipe}}</td>
                                                <td><img class="avatar-img rounded-circle" src="{{asset('images/'.$eq->image_equipe)}}" alt="" height="100px" width="100px" ></td>
												<td>{{$eq->specialite}}</td>
