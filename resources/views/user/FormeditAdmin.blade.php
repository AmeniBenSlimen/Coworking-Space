...
<script src="https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.4.0/dropzone.js"></script>
	...
	<div class="container">
        ...
        <form method="POST" action="{{route('FormeditAdminBD')}}">
                @csrf
                <input type="hidden" name="id" value="{{$admin->id}}" />
                        ...
                        @if(session()->get('success'))
                                    ...
                                    @endif
				<h3 class="text-center">Edit Admin Information</h3>
                ...
                <div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="form-group">
							...
							<input type="date" name="date_naissance" class="form-control" value="{{$admin->date_naissance}}" required>
						</div>
					</div>
				</div>
				<div class="row">
                ...
                <div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="form-group">
							...
							<input id="image_equipe" type="file" name="image_equipe" value="{{$admin->photo}}" class="form-control" required>
