<div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				<a href="{{route('welcome')}}" class="logo"> <img src="{{asset('images/'. Auth::user()->photo )}}"   class="avatar-img rounded-circle"width="50" height="70" alt="logo"> <span class="logoclass">Coworking</span> </a>
